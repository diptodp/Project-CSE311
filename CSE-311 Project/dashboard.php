...
<body>
    <div class="sp">
        <img src="image/banner3.jpg" alt="elephant" />
        ...
        <header class="shadow">
            ...
            <nav class="nav" id="nav-menu">
                ...
                <ul class="nav_list">
                    <li class="nav_item">
                        <a href="displayemp.php" class="link link-theme link-arrow">
                            <button class="favorite styled" type="button">Employees
                            </button></a>
                    </li>

                    <li class="nav_item">
                        <a href="displaycust.php" class="link link-theme link-arrow">
                            <button class="favorite styled" type="button">Customers
                            </button></a>
                    </li>
                    <li class="nav_item">
                    ...
                    <li class="nav_item olduser">
                        <div class="dropdown">
                            <button class="dropbtn"><strong>Hi, ADMIN &#11167</strong></button>
                            <div class="dropdown-content">
                                <div class="dropdown-content2">
                                <a href="home.html">Home</a>
                                <hr />
                                    <a href="emp_cre.php">Create Employee</a>
                                    
                                </div>
                                <hr />
                                <a href="login.php">Logout <i class="fa fa-power-off"></i></a>
