...
<head>
    ...
    <link rel="stylesheet" href="Emp_profile.css" />
                            ...
                            <div class="col-sm-8">
                                <div class="card-block">
                                    ...
                                    <div class="row">
                                      ...
                                      $sql = "select *from employee_info where Emp_id = '$test'";  
...
while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
    ...
    <p class="m-b-10 f-w-600"><strong>Full Name</strong></p>
    <h6 class="text-muted f-w-400">'.$ename.'</h6>
</div>

<div class="col-sm-6">
    <p class="m-b-10 f-w-600"><strong>Joining Date</strong></p>
    <h6 class="text-muted f-w-400">'.$join_date.'</h6>
</div>
...
<div class="col-sm-6">
    <p class="m-b-10 f-w-600"><strong>Salary</strong></p>
    <h6 class="text-muted f-w-400">'.$salaryy.'</h6>
</div>';
}
?>
