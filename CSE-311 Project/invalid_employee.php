...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="invalid_employee.css">
...
<body>
    ...
    <div class="container">
        <div class="containp">
            <div class="img">
                <img src="image/wave2.png">
            </div>
            <div class="login-content">
                <form action="emp_config.php" method="post" name="f1">
                    <img src="image/avatar2.svg">
                    <h2 class="title"style="color: #7B68EE">Hi,<br>Welcome back</h2>
                    <h4 class="title2"style="color: red">Invalid Employee ID or Password.</h4>
