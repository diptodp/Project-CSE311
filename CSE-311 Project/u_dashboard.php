                ...
                <ul class="nav_list">
                    ...
                    <li class="nav_item">
                        <!-- <a href="Upcust.php" class="link link-theme link-arrow">
                            ...
                            <?php
                            echo '<button class="favorite styled"><a style="color: white" href="Upcust.php ? upid='.$_SESSION['user_name'].'" class="link link-theme link-arrow">Edit Profile</a></button>'
                            ?>
                    </li>
                    ...
                    <li class="nav_item">
                        <a href="pay.html" class="link link-theme link-arrow">
